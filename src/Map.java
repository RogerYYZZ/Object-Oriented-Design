...
//	one.setX1(one.getInit_x()+parent.getFrame());
//	one.setY1(one.getInitY());
	if(plane != null && isAll == false){
		...
		//if collisiton between plane1, plane2, delete plane2
		if(checkCollisionsGDArea() == true ){
			p1Disappear = true;
			parent.timer.stop();
			JOptionPane.showMessageDialog(parent,"You fail!");
			try {
				AudioInputStream audioIn = AudioSystem.getAudioInputStream (new File("whiff.wav"));
		...
		//if collisiton between plane1, plane3, delete plane3
		...
		//if collisiton between plane2, plane3, delete plane2
...
public void mousePressed (MouseEvent event) {
	...
	//if(p2Pressed == true && p3Pressed == true) System.out.println ("Collision between p2 & p3");
	repaint();
...
//	 int x1 = one.getInitX()+this.parent.getFrame(); 
//	 int y1 = one.getInitY();
//	 int x2 = two.getInitX()+2*this.parent.getFrame();
//	 int y2 = two.getInitY()+2*this.parent.getFrame();
	 int x1 = one.getX1();
	 int y1 = one.getY1();
	 int x2 = two.getX1();
	 int y2 = two.getY1();
...
//	 int x1 = one.getInitX()+this.parent.getFrame(); 
//	 int y1 = one.getInitY();
//	 int x3 = three.getInitX();
//	 int y3 = three.getInitY()+this.parent.getFrame();
	int x1 = one.getX1();
	 int y1 = one.getY1();
	 int x3 = three.getX1();
	 int y3 = three.getY1();
